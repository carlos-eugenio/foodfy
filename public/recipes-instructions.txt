module.exports = [
    ...
    },
    {
      ...
      information: 'Pizza de liquidificador é uma receita deliciosa e super simples de preparar. Feita toda no liquidificador, ela é bem prática para o dia a dia.'
    },
    {
      id: "assinhas-de-frango-ao-barbecue",
    ...
    {
      id: "triplo-bacon-burger-novo",
      image: 'https://rocketseat-cdn.s3-sa-east-1.amazonaws.com/launchbase/receitas/burger.png',
      title: 'Triplo bacon burger (Novo)',
      author: 'Jorge Relato',
      ingredients: [
        '3 kg de carne moída (escolha uma carne magra e macia)',
        '300 g de bacon moído',
    ...
    {
      id: "pizza-4-estacoes-novo",
      image: 'https://rocketseat-cdn.s3-sa-east-1.amazonaws.com/launchbase/receitas/pizza.png',
      title: 'Pizza 4 estações (Novo)',
      author: 'Fabiana Melo',
      ingredients: [
        '1 xícara (chá) de leite',
        '1 ovo',
    ...
    {
      id: "assinhas-de-frango-ao-barbecue-novo",
      image: 'https://rocketseat-cdn.s3-sa-east-1.amazonaws.com/launchbase/receitas/asinha.png',
      title: 'Asinhas de frango ao barbecue (Novo)',
      author: 'Vania Steroski',
      ingredients: [
        '12 encontros de asinha de galinha, temperados a gosto',
        '2 colheres de sopa de farinha de trigo',
    ...
    {
      id: "lasanha-mac-n-cheese-novo",
      image: 'https://rocketseat-cdn.s3-sa-east-1.amazonaws.com/launchbase/receitas/lasanha.png',
      title: "Lasanha mac n' cheese (Novo)",
      author: 'Juliano Vieira',
      ingredients: [
        'massa pronta de lasanha',
        '400 g de presunto',
    ...
    {
      id: "espaguete-ao-alho-novo",
      image: 'https://rocketseat-cdn.s3-sa-east-1.amazonaws.com/launchbase/receitas/macarrao.png',
      title: 'Espaguete ao alho (Novo)',
      author: 'Júlia Kinoto',
      ingredients: [
        '1 pacote de macarrão 500 g (tipo do macarrão a gosto)',
        '1 saquinho de alho granulado',
    ...
    {
      id: "docinhos-pao-do-ceu-novo",
      image: 'https://rocketseat-cdn.s3-sa-east-1.amazonaws.com/launchbase/receitas/doce.png',
      title: 'Docinhos pão-do-céu (Novo)',
      author: 'Ricardo Golvea',
      ingredients: [
        '1 kg de batata - doce',
        '100 g de manteiga',
    ...
    {
      id: "burger-moda-da-casa",
      image: 'https://rocketseat-cdn.s3-sa-east-1.amazonaws.com/launchbase/receitas/burger.png',
      title: 'Burger moda da casa',
      author: 'Jorge Relato',
      ingredients: [
        '3 kg de carne moída (escolha uma carne magra e macia)',
        '300 g de bacon moído',
